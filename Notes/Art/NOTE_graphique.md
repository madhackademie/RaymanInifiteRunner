...
- **Alpha serré** : **pas d’anti-aliasing** sur la découpe ; **bordure noire nette** (#000) autour du sujet ; pas de halo / glow / brouillard (perf mobile + overdraw).
...
- **Glow, fog, bloom, aura, soft haze** autour du sujet ; **frange grise semi-transparente** ou dégradé alpha sur les bords (anti-aliasing).

### Alpha / perf (décision auteur 2026-09-08 · MAJ contour 2026-09-23)

| Règle | Pourquoi |
|--------|----------|
| Silhouette **coupée nette** : **NO anti-aliasing**, contour extérieur **noir opaque** | Moins d’overdraw ; évite halo blanc sur HUD sombre |
