...
| [ ] | `[BZ-SALE-BANDEAU-LAYOUT-001]` | `SaleChannelsScreen.prefab` | 1 | `Assets/Docs/Bezi/PROMPTS_Bezi_sale_bandeau_layout_filigrane.md` | branche courante | Bandeaux sous HUD PA — padding top 56 (+8px viewport option) |
| [ ] | `[BZ-SALE-BANDEAU-VOISIN-FILIGRANE-001]` | `SaleChannelBandeauView.prefab` | 1 | `Assets/Docs/Bezi/PROMPTS_Bezi_sale_bandeau_layout_filigrane.md` | branche courante | Illustration stretch sans Preserve Aspect (template) |
| [ ] | `[BZ-SALE-BANDEAU-VOISIN-FILIGRANE-001]` | `SaleChannelsScreen.prefab` | 2 | `Assets/Docs/Bezi/PROMPTS_Bezi_sale_bandeau_layout_filigrane.md` | branche courante | Instance Voisinage α 0.30 — puis Cursor alpha runtime |
