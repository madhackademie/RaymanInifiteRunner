...
- **HUD world V0** (chrome ★ + rangées cadenas, pas le métier prestige) : prefabs livrés + pose auteur `Notes/Farm/NOTE_hud_biofiltre_prefab_en_dur.md`. Réutilise `UiStarRow` existant.
...
| HUD world (pose) | `Notes/Farm/NOTE_hud_biofiltre_prefab_en_dur.md` |
