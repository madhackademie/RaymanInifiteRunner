...
| **`Notes/GDD/IDEA_boucle_reset_prestige_systemes.md`** | Boucle reset / prestige systèmes (type idle miner) — nouveaux compteurs méta, redémarrage accéléré | **Idée** — non validée |
