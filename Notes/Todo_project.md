...
- [ ] **Urgent — stabilisation refs SO plantation** : état actuel avec **2 SO nécessaires** pour la laitue ; supprimer l'un des deux casse la plantation. Prévoir une migration contrôlée des références prefab/scène avant toute suppression (objectif final : un seul SO propre).
