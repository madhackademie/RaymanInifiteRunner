...
| `Notes/Ui/popup_generique.md` | Actif | P1 | Documentation Shop/UI : état réel du flux d’achat, popup item, popup ressources insuffisantes et mode popup générique strict sans fallback. |
