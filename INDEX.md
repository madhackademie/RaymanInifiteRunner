...
| `Notes/GDD/IDEA_boucle_reset_prestige_systemes.md` | A trier | P3 | Idée boucle reset/prestige (idle miner) : recommencer un système pour compteurs méta et boosts permanents. |
